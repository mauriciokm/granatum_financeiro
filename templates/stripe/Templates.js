[
  {
    ...
    filters: [[{field: 'status', condition: 'equal', value: 'succeeded'}]],
    mapper: [
    // include mapping
    ],
    trigger_key: 'new_transactions',
    action_key: 'add_recebimento',
    name: {pt_BR: 'A cada pagamento aprovado na Stripe incluir um recebimento no Granatum Financeiro',
          en: 'For every approved payment on Stripe, generate an accounts receivable on Granatum Financeiro'},
    description: {
      ...
      how_it_works: [{pt_BR: ' Pluga fica de olho em cada novo pagamento aprovado na sua conta da Stripe.',
                      en: 'Pluga keeps an eye on every new approved payment on your Stripe account.'},
